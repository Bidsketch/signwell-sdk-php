...
/**
 * AttachmentRequestsInner Class Doc Comment
 *
 * @category Class
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentRequestsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachmentRequests_inner';
    ...
    */
     ...
     * Sets recipient_id
     *
     * @param string $recipient_id Unique identifier of the recipient that will view the attachment request.
     *
     * @return self
     */
