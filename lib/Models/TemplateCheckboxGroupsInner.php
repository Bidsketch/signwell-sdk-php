...
/**
 * TemplateCheckboxGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TemplateCheckboxGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateCheckboxGroups_inner';
    ...
    */
     ...
     * Sets placeholder_id
     *
     * @param string $placeholder_id The recipient ID associated with the checkbox group.
     *
     * @return self
     */
