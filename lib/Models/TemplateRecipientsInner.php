...
/**
 * TemplateRecipientsInner Class Doc Comment
 *
 * @category Class
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TemplateRecipientsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateRecipients_inner';
    ...
    */
     ...
     *
     * @param string|null $placeholder_name The name of the placeholder you want this recipient assigned to.
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject Email subject for the signature request that the recipient will see. Overrides the general subject for the template.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Email message for the signature request that the recipient will see. Overrides the general message for the template.
     *
     * @return self
     */
