...
/**
 * Nom151CertificateResponseNom151 Class Doc Comment
 *
 * @category Class
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class Nom151CertificateResponseNom151 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Nom151CertificateResponse_nom151';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['validation_url'] === null) {
            $invalidProperties[] = "'validation_url' can't be null";
        }
        if ($this->container['constancia'] === null) {
            $invalidProperties[] = "'constancia' can't be null";
        }
     ...
     * Sets status
     *
     * @param string $status Certificate status (pending, issued, failed)
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id RSA signature / Transaction ID
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string $hash Document digest (SHA-256 hash)
     *
     * @return self
     */
     ...
     * Sets folio
     *
     * @param string $folio Certificate number / Folio
     *
     * @return self
     */
     ...
     * Sets issued_at
     *
     * @param \DateTime $issued_at Certificate issuance timestamp
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string $provider Certificate provider (e.g., SeguriData)
     *
     * @return self
     */
     ...
     * Sets validation_url
     *
     * @param string $validation_url URL to validate the certificate
     *
     * @return self
     */
    public function setValidationUrl($validation_url)
    {
        if (is_null($validation_url)) {
    ...
    {
        return $this->container['constancia'];
    }

    /**
     * Sets constancia
     *
     * @param string $constancia Base64-encoded certificate file
     *
     * @return self
     */
