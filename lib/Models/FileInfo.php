...
class FileInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct($data = null)
    {
        ...
        $this->setIfExists('pages_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pages_number'] === null) {
            $invalidProperties[] = "'pages_number' can't be null";
        }
    ...
    {
        return $this->container['pages_number'];
    }

    /**
     * Sets pages_number
     *
     * @param int $pages_number Number of pages in the file
     *
     * @return self
     */
    public function setPagesNumber($pages_number)
    {
        if (is_null($pages_number)) {
            throw new \InvalidArgumentException('non-nullable pages_number cannot be null');
        }
        $this->container['pages_number'] = $pages_number;
        $this->normalizeAfterSet();
