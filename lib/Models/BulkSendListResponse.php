...
/**
 * BulkSendListResponse Class Doc Comment
 *
 * @category Class
 * @description List of bulk sends with pagination
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkSendListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkSendListResponse';
    ...
    protected static $openAPITypes = [
        'bulk_sends' => '\SignWell\Sdk\Models\BulkSendListItem[]',
        'current_page' => 'int',
        'next_page' => 'int',
        'previous_page' => 'int',
        'total_count' => 'int',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bulk_sends'] === null) {
            $invalidProperties[] = "'bulk_sends' can't be null";
        }
     ...
     * Gets bulk_sends
     *
     * @return \SignWell\Sdk\Models\BulkSendListItem[]
     */
    public function getBulkSends()
    {
        return $this->container['bulk_sends'];
    }

    /**
     * Sets bulk_sends
     *
     * @param \SignWell\Sdk\Models\BulkSendListItem[] $bulk_sends bulk_sends
     *
     * @return self
     */
    public function setBulkSends($bulk_sends)
    {
        if (is_null($bulk_sends)) {
