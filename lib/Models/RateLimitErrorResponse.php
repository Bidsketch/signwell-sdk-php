...
/**
 * RateLimitErrorResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RateLimitErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RateLimitErrorResponse';
    ...
    */
     ...
     * Sets error
     *
     * @param string $error Rate limit error message indicating the limit and reset time
     *
     * @return self
     */
