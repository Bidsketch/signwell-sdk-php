 ...
 */
class ValidationErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets errors
     *
     * @param array<string,mixed> $errors Field-specific validation errors. Keys are field names (e.g., recipients, fields, files). Values can be strings, arrays of strings, or nested objects with further field-specific errors.
     *
     * @return self
     */
