...
/**
 * TemplateAttachmentRequestsInner Class Doc Comment
 *
 * @category Class
 * @package  SignWell\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TemplateAttachmentRequestsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateAttachmentRequests_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the requested attachment.
     *
     * @return self
     */
     ...
     * Sets placeholder_id
     *
     * @param string $placeholder_id Unique identifier of the recipient that will view the attachment request.
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Whether the recipient will need to upload the attachment to successfully complete/sign the document. Defaults to `true`.
     *
     * @return self
     */
