...
/**
 * AttachmentRequestInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class AttachmentRequestInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachmentRequestInfo';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the attachment request
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url URL of the uploaded attachment (when available)
     *
     * @return self
     */
